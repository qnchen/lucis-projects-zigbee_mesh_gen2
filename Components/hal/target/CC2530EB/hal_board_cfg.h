 ...
 */
  ...
  #define HAL_NUM_LEDS            2// 1 porting by lihao 20150721
#else
...
#define LED1_POLARITY     ACTIVE_HIGH
...
#if   defined(HAL_BOARD_CC2530EB_REV17)||defined(HAL_BOARD_CC2530EB_REV13)//porting by lihao 20150721
  /* 2 - Red */
  #define LED2_BV           BV(1)
 ...
 #if 0  //erase for soloboard by lihao 20150722
  /* 3 - Yellow */
  ...
  /* IO 1_2 */
  #define IO1_0_BV            BV(0)
  #define IO1_0_SBIT         P1_0
  #define IO1_0_DDR          P1DIR
  #define IO1_0_POLARITY     ACTIVE_HIGH

  /* IO 1_3 */

  #define IO1_1_BV           BV(1)
  #define IO1_1_SBIT         P1_1
  #define IO1_1_DDR          P1DIR
  #define IO1_1_POLARITY     ACTIVE_HIGH
#endif
...
{                                                                \
  ...
  PREFETCH_ENABLE();                                             \
  /*GPIO SETUP*/				\
  P0SEL &= ~0x01;								/* P0_0 as GPIO function*/\
  P0DIR |= 0x01;								/* P0_0 output */	\
                                                                  \
  /* set direction for GPIO outputs  */                          			\
  P1SEL &= ~0x03;       					\
  LED1_DDR |= LED1_BV;								 /* led1 output */		\
  LED2_DDR |= LED2_BV;								 /* led2 output */     \
...
/* ----------- LED's ---------- */
  ...
  #define HAL_STATE_LED4()          HAL_STATE_LED1()
#else
  #define HAL_TURN_OFF_LED1() 	    st( LED1_SBIT = 1; )
  #define HAL_TURN_OFF_LED2() 	    st( LED2_SBIT = 1; )
  #define HAL_TURN_OFF_LED3() 	    HAL_TURN_OFF_LED1()
  #define HAL_TURN_OFF_LED4() 	    HAL_TURN_OFF_LED1()

  #define HAL_TURN_ON_LED1()		st( LED1_SBIT = 0; )
  #define HAL_TURN_ON_LED2()		st( LED2_SBIT = 0; )
  #define HAL_TURN_ON_LED3()		HAL_TURN_ON_LED1()
  #define HAL_TURN_ON_LED4()		HAL_TURN_ON_LED1()
...
/* ----------- XNV ---------- */
#define XNV_SPI_BEGIN()             //st(P1_3 = 0;)  debug by lihao 20160226
...
#ifndef HAL_DMA
#define HAL_DMA TRUE   //chaokw uart
#endif
...
#ifndef HAL_AES_DMA
//#define HAL_AES_DMA TRUE   //chaokw
#endif
