...
} ZDO_Permit_Join_Device_Ext_t;

typedef struct ZDO_Permit_Join_Device      //chaokw
{
	ZDO_Permit_Join_Device_Ext_t permit_device; 
	struct ZDO_Permit_Join_Device *next;
} ZDO_Permit_Join_Device_t;
...
extern uint8 join_device_extaddr[SADDR_EXT_LEN];
extern ZDO_Permit_Join_Device_t *zdo_join_device; //chaokw
