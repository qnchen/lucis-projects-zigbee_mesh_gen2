...
//chaokw
// Times of each PANID scan
//#define ZG_NWK_DISCOVERY_COUNT     0x20
//#define ZG_NWK_DISCOVERY_COUNT     10
//#define ZG_NWK_SCAN_PANID_COUNT    6
//#define ZG_NWK_SCAN_PANID_COUNT    5
#define PANID_INCREASE_CNT     6     //single 6   all 3
#define SCAN_TIMES_PER_CHANNEL 4  //chaokw
#define ZG_NWK_DISCOVERY_COUNT (CHANNEL_CNT*SCAN_TIMES_PER_CHANNEL) //Times of each PANID scan
...
extern const uint16 zgConfigPANID_Table[];  //chaokw
extern uint8 zgScanNwkCount;
