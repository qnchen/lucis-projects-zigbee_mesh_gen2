...
// Default channle mask
#ifdef WIFI_FREQUENCY_SELECT
	uint32 __xdata zgDefaultChannelMask = MAX_CHANNELS_24GHZ;
#endif
...
// Add the table for PANID conflict to discovery the network   //chaokw panid
#if 0
const uint16 zgConfigPANID_Table[] = {ZDAPP_CONFIG_PAN_ID, ZDAPP_CONFIG_PAN_ID + 1, ZDAPP_CONFIG_PAN_ID + 2,
                                      ZDAPP_CONFIG_PAN_ID + 3, ZDAPP_CONFIG_PAN_ID + 4, ZDAPP_CONFIG_PAN_ID + 5};//,
										//ZDAPP_CONFIG_PAN_ID + 6, ZDAPP_CONFIG_PAN_ID + 7, ZDAPP_CONFIG_PAN_ID + 8,
										//ZDAPP_CONFIG_PAN_ID + 9, ZDAPP_CONFIG_PAN_ID + 10, ZDAPP_CONFIG_PAN_ID + 11,
										//ZDAPP_CONFIG_PAN_ID + 12, ZDAPP_CONFIG_PAN_ID + 13, ZDAPP_CONFIG_PAN_ID + 14};
#else										
const uint16 zgConfigPANID_Table[8] = {ZDAPP_CONFIG_PAN_ID, ZDAPP_CONFIG_PAN_ID + 1, ZDAPP_CONFIG_PAN_ID + 2,
								ZDAPP_CONFIG_PAN_ID + 3, ZDAPP_CONFIG_PAN_ID + 4, ZDAPP_CONFIG_PAN_ID + 5, ZDAPP_CONFIG_PAN_ID + 6,
								ZDAPP_CONFIG_PAN_ID + 7};		
#endif
uint8 zgScanNwkCount;
...
static CONST zgItem_t zgItemTable[] =
{
  ...
  // comment it for not read the channellist from NV, or will use the NV channellist info but not the channel in the config file
  //{
...
#ifdef WIFI_FREQUENCY_SELECT
	{
		ZCD_NV_CHANNEL_MASK, sizeof( zgDefaultChannelMask ), &zgDefaultChannelMask
	},
#endif
#endif // NV_INIT

  {
    ZCD_NV_MULTIWAY, sizeof(PROT_GROUP_STRUCT), &Prot_Group_T
  },  
...
#ifdef WIFI_FREQUENCY_SELECT
	zgDefaultChannelList = zgDefaultChannelMask;
#endif
}
