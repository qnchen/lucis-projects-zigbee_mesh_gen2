...
// 0x0401 – 0x0FFF
#define APP_NV_AUTH_GLOBAL_CONFIG         0x0401   //chaokw
#define APP_NV_AUTH_KEY_LIST              0x0402
#define ZCD_NV_CHANNEL_MASK               0x0403      
#define ZCD_NV_MULTIWAY                   0x0404
...
#define ZNwkNoRoute                 0xcd    //chaokw
...
#define ZMacTransactionOverFlow     0xf1  //chaokw
...
//chaokw
#define ZDO_P2P_REQ               0xE1    // CPU send data to zigbee
#define ZDO_P2P_RSP               0xE2    // zigbee send data to CPU
#define ZDO_GROUP_REQ             0xE3    // CPU send group info to zigbee
#define ZDO_GROUP_RSP             0xE4    // zigbee send group result to CPU
#define ZDO_BROADCAST_REQ         0xEA    // COORDINATOR send BROADCAST info to ROUTER/DEVICE
#define ZDO_BROADCAST_RSP         0xEB    //ROUTER/DEVICE send BROADCAST to COORDINATOR


#define ZDO_NODE_UPDATE           0xE5     //CPU send key to Zigbee for register/DELETE Node
#define ZDO_CHANNEL_UPDATE        0xE6     //MCU send the wifi channel to zigbee module
#define ZDO_MAC_REQ               0xE7     //MCU send msg to Zigbee to get the zigbee MAC
#define ZDO_FW_VERSION_REQ        0xE8     //MCU->Zigbee get the FW version
#define ZDO_FW_UPDATE_REQ         0xE9     //MCU->Zigbee request for update the FW
#define ZDO_MULTIWAY_SET_REQ      0xEC
#define ZDO_ACTIVE_CNT_REQ        0xED
#define ZDO_NWKINFO_REQ               0xEE 
