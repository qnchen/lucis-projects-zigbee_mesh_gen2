...
/* Default values */
  ...
  #define MT_UART_DEFAULT_OVERFLOW       FALSE  //TRUE  chaokw
#endif

#if !defined MT_UART_DEFAULT_BAUDRATE
  //#if (ZSTACK_DEVICE_BUILD == DEVICE_BUILD_COORDINATOR)    //chaokw
  #if defined ZDO_COORDINATOR
        #define MT_UART_DEFAULT_BAUDRATE         HAL_UART_BR_115200   //HAL_UART_BR_115200
  #else
