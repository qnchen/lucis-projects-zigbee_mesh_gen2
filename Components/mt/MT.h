...
#define MT_SYS_P2P_TRANSFER                          0x20
#define MT_SYS_GROUP_TRANSFER                     0x22
#define MT_SYS_BROADCAST_TRANSFER             0x23

#define MT_SYS_CHANNEL_UPDATE                     0x34    //MCU->zigbee select a proper channel to escape the wifi interefrece
#define MT_SYS_MAC_REQ                                   0x35    //MCU->zigbee request for the MAC
#define MT_SYS_FW_VERSION_REQ                     0x36    //MCU->zigbee request for FW version
#define MT_SYS_FW_UPDATE_REQ                      0x37    //MCU->zigbee update FW request
#define MT_SYS_ACTIVE_CNT_REQ                      0x41   
#define MT_SYS_MULTIWAY_SET_REQ                 0x42
#define MT_SYS_MULTIWAY_SEND_REQ              0x43
#define MT_SYS_COORDINATOR_ONLINE_REQ     0x44


#define MT_SYS_NWKINFO_REQ                           0x90
...
#define MT_SYS_RESET_CLEAR_NV   3
