...
#if defined( ZDO_COORDINATOR )   //chaokw uart
	#define MT_UART_TX_BUFF_MAX  128
	#define MT_UART_RX_BUFF_MAX  256//128
#else
...
// If want to open Watchdog, need to open this
//#define WDT_IN_PM1    //chaokw watchdog

/* WATCHDOG TIMER DEFINITIONS: To call this need to MACR define "WDT_IN_PM1" */
